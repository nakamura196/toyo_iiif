...
for book in range(1, 17):
    ...
    while loop_flg:
        ...
        if not os.path.exists(path):
            ...
            # url = "http://www.tbcas.jp/ja/lib/lib4/001/page4/thumbnail.jpg"
            # url = "http://www.tbcas.jp/ja/lib/lib4/001/index.html#4"
            url = "http://www.tbcas.jp/ja/lib/lib4/"+str(book).zfill(3)+"/pageindices/index"+str(page)+".html"
            ...
            try:
                ...
                src = "http://www.tbcas.jp/ja/lib/lib4/"+str(book).zfill(3)+"/page"+str(page)+"/x1.jpg"
                print(src)

                image = Image.open(urllib.request.urlopen(src))
                width, height = image.size

                thumb = "http://www.tbcas.jp/ja/lib/lib4/"+str(book).zfill(3)+"/page"+str(page)+"/thumbnail.jpg"
            except:
